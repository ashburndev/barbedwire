		...
		<div id="list-document" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="summary" title="${message(code: 'document.summary.label', default: 'Summary')}" />
				...
				<g:each in="${documentInstanceList}" status="i" var="documentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${documentInstance.id}">${fieldValue(bean: documentInstance, field: "summary")}</g:link></td>
