	...
	<body>
		...
		<div id="show-document" class="content scaffold-show" role="main">
			...
			<ol class="property-list document">
				...
				<g:if test="${documentInstance?.comments}">
				<li class="fieldcontain">
					<span id="comments-label" class="property-label"><g:message code="document.comments.label" default="Comments" /></span>
				...
				<g:if test="${documentInstance?.summary}">
				<li class="fieldcontain">
					<span id="summary-label" class="property-label"><g:message code="document.summary.label" default="Summary" /></span>
					
						<span class="property-value" aria-labelledby="summary-label"><g:fieldValue bean="${documentInstance}" field="summary"/></span>
